...
/* ─── Image processing ──────────────────────────────────────────────────────── */
function parseLogoImage(file: File): Promise<ImageData> {
...
/* ─── Component ───────────────────────────────────────────────────────────── */
export default function FramerLiquidMetalLogo({
  imageSource,
  speed = 0.3,
  dispersion = 0.015,
  edge = 0.4,
  ...
  /* ─── Handle resize + texture ───────────────────────────────────────────── */
  useEffect(() => {
    if (!gl || !canvasRef.current || !imageData) return
    const canvas = canvasRef.current
  ...
  useEffect(() => {
    ...
    const animate = (currentTime: number) => {
      ...
      const normalizedTime = totalAnimationTime.current % 10000
